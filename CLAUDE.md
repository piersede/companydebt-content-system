...
- `12-structure-governance.md` — openings, endings, section discipline, first-fold pattern, persona-state purity gate (§12), route separation (§13), distressed first-screen (§14), section purpose test (§15), FAQ completion (§16), decision support density (§17), distressed-page body control (§18), support module order (§19)
