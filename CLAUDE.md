...
- `12-structure-governance.md` — openings, endings, section discipline, first-fold pattern, persona-state purity gate (§12), route separation (§13), distressed first-screen (§14), section purpose test (§15), FAQ completion (§16), decision support density (§17), distressed-page body control (§18), support module order (§19), decision flow enforcement (§20), process placement rule (§21), section intent purity (§22), persona-state lock (§23), escalation flow (§24), anti-genericity gate (§25), urgency insertion rule (§26), decision hierarchy for distress pages (§27), section role discipline (§28), standard insolvency article structures (§29)
...
- `23-prose-quality-gates.md` — 13 enforcement gates for YMYL financial copy: fact pattern, scenario validity, meta-copy, human-impact, product-type clarity, generic-intensifier ban, YMYL opening router, financial objectivity, sentence texture, original-source-only constraint, distress reassurance statistics constraint (§11), body decision density gate (§12), human authority gate for YMYL distress pages (§13), intent payoff rule (§14)
