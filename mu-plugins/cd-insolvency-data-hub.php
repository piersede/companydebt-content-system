...
function cd_datahub_schema_graph( $slug, $page_id ) {
    ...
    if ( 'uk-insolvency-statistics' === $slug ) {
        ...
        $faq_items = array(
            array(
                'q' => 'How many UK company insolvencies were there in June 2026?',
                'a' => 'There were 1,845 registered company insolvencies in England and Wales in June 2026, on a seasonally adjusted basis. That was little changed from May 2026 and 10% lower than June 2025. Scotland recorded 104 insolvencies and Northern Ireland 18 in the same month.',
            ),
            array(
                'q' => 'What is the current UK company insolvency rate?',
                'a' => 'The 12-month rolling company insolvency rate for England and Wales was 50.5 per 10,000 active companies in the year to June 2026 — equal to one in 198 companies. The rate is lower than the 52.4 per 10,000 recorded a year earlier, and well below the 113.1 per 10,000 peak of the 2008–09 recession.',
            ),
            array(
                'q' => 'Which procedure accounts for the most UK company insolvencies?',
                'a' => "Creditors' Voluntary Liquidations (CVLs) account for the largest share. There were 1,364 CVLs in June 2026 — 74% of all company insolvencies for the month. Compulsory liquidations (276) and administrations (191) followed, with a small number of CVAs (14) and no receiverships.",
            ),
            array(
                'q' => 'Which UK sectors have the most company insolvencies?',
                'a' => 'Across the 12 months to June 2026, construction (3,805, 17%), wholesale and retail (3,463, 15%), and accommodation and food services (3,233, 14%) had the largest counts. Administrative services, professional services and manufacturing followed. These are volumes, not failure rates — larger sectors have more registered companies and so tend to have more insolvencies.',
            ),
            array(
                'q' => 'When is the next UK insolvency statistics release?',
                'a' => 'The Insolvency Service publishes monthly company insolvency statistics. The next scheduled release is 18 August 2026. This page is updated each month from the official release.',
            ),
            array(
        ...
        return array(
            array(
                ...
                'description'          => 'Monthly company insolvency statistics for the United Kingdom by procedure, sector and jurisdiction. June 2026 release published 17 July 2026 by the Insolvency Service. Includes headline counts (1,845 England and Wales) and the 12-month rolling rate (50.5 per 10,000).',
                'url'                  => $page_url,
                'creator'              => $org_ref,
                'publisher'            => $org_ref,
                'spatialCoverage'      => array( '@type' => 'Place', 'name' => 'United Kingdom' ),
                'temporalCoverage'     => '2000-01/2026-06',
    ...
    if ( 'dissolutions-vs-insolvencies' === $slug ) {
        ...
        return array(
            array(
                ...
                'description'      => 'Monthly UK company dissolutions and incorporations from Companies House, set against formal company insolvencies from the Insolvency Service. Latest month: 47,189 dissolutions and 63,572 incorporations (Companies House, June 2026) against 1,845 formal insolvencies (Insolvency Service, June 2026), or about 26 dissolutions for every insolvency.',
                'url'              => $page_url,
                'creator'         => $org_ref,
                'publisher'       => $org_ref,
                'spatialCoverage' => array( '@type' => 'Place', 'name' => 'United Kingdom' ),
                'temporalCoverage' => '2025-02/2026-06',
                'datePublished'   => $published,
                'dateModified'    => $modified,
    ...
    if ( 'cvl-statistics' === $slug ) {
        ...
        return array(
            array(
                ...
                'description'      => 'Monthly counts of creditors\' voluntary liquidations (CVLs) in England and Wales since 2000, with the share of all company insolvencies and the rate per 10,000 active companies. CVLs are the largest single company insolvency procedure. Latest month (June 2026): 1,364 CVLs, 74% of all company insolvencies. Source: Insolvency Service.',
                'url'              => $page_url,
                'creator'         => $org_ref,
                'publisher'       => $org_ref,
                'spatialCoverage' => array( '@type' => 'Place', 'name' => 'England and Wales' ),
    ...
    if ( 'administration-statistics' === $slug ) {
        ...
        return array(
            array(
                ...
                'description'      => 'Monthly counts of companies entering administration in England and Wales since 2000, with the share of all company insolvencies and the rate per 10,000 active companies. Latest month (June 2026): 191 administrations, 10% of all company insolvencies. Source: Insolvency Service.',
                'url'              => $page_url,
                'creator'         => $org_ref,
                'publisher'       => $org_ref,
                'spatialCoverage' => array( '@type' => 'Place', 'name' => 'England and Wales' ),
