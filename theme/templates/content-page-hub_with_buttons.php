<?php
/**
 * Template Name: Hub with Buttons
 */

get_header();

if ( have_posts() ) { ?>
   <div class="section-full-width-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 page-header">
                    ...
                    // Mirrors the take-the-test-template hero structure so the
                    // shared hero CSS applies without template-specific rules.
...
// "Get in Touch Today" contact CTA block — shared with take-the-test template.
// CSS for .footer-cta-block is sitewide so no scope adjustments needed.
