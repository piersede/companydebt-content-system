...
<?php
				$proc_steps = is_page( 'close-my-company' ) ? array(
					...
					array( '<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.8 10A10 10 0 1 1 17 3.34"/><path d="m9 11 3 3L22 4"/></svg>', 'The Company Is Formally Closed', 'Once the two-month notice period passes with no valid objection, the company is struck off the register and dissolved. You will know the likely timescale and costs up front, with no obligation to proceed.' ),
				)
				: array(
					array( '<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z"/><path d="M14 2v5h5"/><path d="M8 13h6"/><path d="M8 17h6"/><path d="M8 9h2"/></svg>', 'Tell Us About the Company', 'Provide a few approximate figures about the company&rsquo;s debts, assets and current financial position.' ),
