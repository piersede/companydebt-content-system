<?php
/**
 * Template Name: Quick Quote (Original, retained)
 *
 * Colleague's original cosmetic redesign of /quick-quote/, built in
 * milestones through 2026-07-24. This is the page reviewed at the start of
 * this project (before the options-first rebuild) — a liquidation-only quote
 * calculator, not the options-first positioning.
 *
 * 2026-07-28 — moved here from templates/quick-quote.php when the new
 * options-first design (design-handoff/quick-quote-options-page-design-
 * brief.md) was approved and swapped onto /quick-quote/ itself. This file
 * now lives at templates/quick-quote-options.php (this content moved into
 * that path; the file itself was not renamed), kept live at
 * /quick-quote-options/ in case it's still wanted. Nothing else changed —
 * same slugs, same post IDs, same functions.php routing, same
 * qq-redesign.css (its scoping is by CSS class, not by file path, so the
 * original design's styling followed this markup automatically).
 *
