...
5. **Google search quality evaluator guidelines** — 12-agent audit system based on Google's 182-page QRG. Covers YMYL, E-E-A-T, page quality rating (Lowest through Highest), and Needs Met scoring. Standalone — not part of the core workflow, invoked manually. (`22`)
