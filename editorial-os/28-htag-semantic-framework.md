...
8. Every page must include an FAQ section: `H2: Frequently Asked Questions About (Primary Keyword)`, followed by `H2: Related Guides`. **Related Guides must be the FINAL H2 in the visible article, immediately after FAQ.** No other editorial H2 may appear after FAQ, and FAQ may not appear after Related Guides. (Changed 2026-07-08: Related Guides now always follows FAQ, reversing the prior "FAQ is final H2" rule.)
...
11. **Is Related Guides the final H2, immediately after FAQ?** (FAQ must precede Related Guides; no other editorial H2 may follow FAQ.)
